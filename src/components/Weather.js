...
const Weather = (props) => {
    ...
    return ( 
        <div>
        {props.icon && <p><span className='biggerText'><img src={path} alt='icon'></img></span></p>}
        {props.city && props.country && <p>location: <span className='biggerText'>{props.city} {props.country}</span></p>}
        {props.temperature && <p>temperature: <span className='biggerText'>{props.temperature}°C</span></p>}
